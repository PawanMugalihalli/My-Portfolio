    ...
    onModalOpen({
      ...
      onConfirm: async () => {
        ...
        try {
          ...
          // Send the first email to Pawan
          await emailjs.send("service_gnivft6", "template_7e62evl", templateParams, "tKVMq3YI2M0jbdSbu").then(
            (response) => {
              if (response.status === 200 && response.text === "OK") {
                sentEmails++;
              }
          ...
          // Send the second email to visitors
          await emailjs.send("service_gnivft6", "template_jw36aqd", templateParams, "tKVMq3YI2M0jbdSbu").then(
            (response) => {
              if (response.status === 200 && response.text === "OK") {
                sentEmails++;
              }
